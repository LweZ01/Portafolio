...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Reemplace con su correo electrónico en FormSubmit
      const formSubmitUrl = 'https://formsubmit.co/j53543324@gmail.com';
      
      // Prepare el formulario de datos para FormSubmit.
      const submitData = new FormData();
      submitData.append('name', formData.name);
      submitData.append('email', formData.email);
      submitData.append('message', formData.message);
      submitData.append('_subject', 'New Message from the Portfolio Website'); // Asunto del correo
      submitData.append('_captcha', 'false'); // Disable captcha
      submitData.append('_template', 'table'); // Email format as a table
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Have questions? Send me a message, and I'll get back to you as soon as possible.
        </p>
      </div>
