...
export default function FullWidthTabs() {
  ...
  const fetchData = useCallback(async () => {
    try {
      //  Obtener datos de Supabase de forma paralela
      const [projectsResponse, certificatesResponse] = await Promise.all([
        supabase.from("projects").select("*").order('id', { ascending: true }),
        supabase.from("certificates").select("*").order('id', { ascending: true }), 
      ]);

      // Gestión de errores para cada solicitud
  ...
  useEffect(() => {
    // Intenta obtenerlo primero del localStorage para que se cargue más rápido.
  ...
  // El resto de los componentes (instrucción de retorno) no ha cambiado.
  return (
