...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "www.linkedin.com/in/jr-romero1",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@ssss.lwez",
    icon: Instagram,
    url: "https://www.instagram.com/ssss.lwez/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@LweZ",
    icon: Youtube,
    url: "https://www.youtube.com/@LweZ-n8f",
    color: "#FF0000",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@lwezta",
    color: "black",
